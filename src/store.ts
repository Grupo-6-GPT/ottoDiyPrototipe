...
export const AVAILABLE_MOVES = [
  { name: 'Caminar adelante',    icon: '↑',  command: 'WALK_F',          color: '#818CF8', bodyPart: 'legs', category: 'movement', arduinoDuration: 2160 },
  { name: 'Caminar atrás',       icon: '↓',  command: 'WALK_B',          color: '#818CF8', bodyPart: 'legs', category: 'movement', arduinoDuration: 2160 },
  { name: 'Girar izquierda',     icon: '←',  command: 'TURN_L',          color: '#818CF8', bodyPart: 'legs', category: 'movement', arduinoDuration: 1120 },
  { name: 'Girar derecha',       icon: '→',  command: 'TURN_R',          color: '#818CF8', bodyPart: 'legs', category: 'movement', arduinoDuration: 1120 },
  { name: 'Caminar rápido',      icon: '↑',  command: 'WALK_F_FAST',     color: '#818CF8', bodyPart: 'legs', category: 'movement', arduinoDuration: 1360 },
  { name: 'Caminar lento',       icon: '↑',  command: 'WALK_F_SLOW',     color: '#818CF8', bodyPart: 'legs', category: 'movement', arduinoDuration: 3600 },
  { name: 'Retroceder rápido',   icon: '↓',  command: 'WALK_B_FAST',     color: '#818CF8', bodyPart: 'legs', category: 'movement', arduinoDuration: 1360 },
  { name: 'Retroceder lento',    icon: '↓',  command: 'WALK_B_SLOW',     color: '#818CF8', bodyPart: 'legs', category: 'movement', arduinoDuration: 3600 },
  { name: 'Girar izq rápido',    icon: '←',  command: 'TURN_L_FAST',     color: '#818CF8', bodyPart: 'legs', category: 'movement', arduinoDuration: 880 },
  { name: 'Girar der rápido',    icon: '→',  command: 'TURN_R_FAST',     color: '#818CF8', bodyPart: 'legs', category: 'movement', arduinoDuration: 880 },
  { name: 'Saltar',              icon: '⤴',  command: 'JUMP',            color: '#F472B6', bodyPart: 'legs', category: 'dance',    arduinoDuration: 520 },
  { name: 'Moonwalk adelante',    icon: '🌙',  command: 'MOONWALK',        color: '#FBBF24', bodyPart: 'legs', category: 'dance',    arduinoDuration: 1840 },
  { name: 'Moonwalk atrás',      icon: '🌙',  command: 'MOONWALK_B',      color: '#FBBF24', bodyPart: 'legs', category: 'dance',    arduinoDuration: 1840 },
  { name: 'Giro 360°',           icon: '↻',  command: 'SPIN',            color: '#FBBF24', bodyPart: 'body', category: 'dance',    arduinoDuration: 1600 },
  { name: 'Giro izquierda lento', icon: '⟲',  command: 'SPIN_L',          color: '#FBBF24', bodyPart: 'body', category: 'dance',    arduinoDuration: 2000 },
  { name: 'Giro derecha lento',  icon: '⟳',  command: 'SPIN_R',          color: '#FBBF24', bodyPart: 'body', category: 'dance',    arduinoDuration: 2000 },
  ...
  { name: 'Marcha adelante',      icon: '🚶', command: 'MARCH_F',         color: '#60A5FA', bodyPart: 'legs', category: 'movement', arduinoDuration: 1900 },
  { name: 'Marcha atrás',         icon: '🚶', command: 'MARCH_B',         color: '#60A5FA', bodyPart: 'legs', category: 'movement', arduinoDuration: 1900 },
  { name: 'Sigilo adelante',      icon: '🐾', command: 'SNEAK_F',         color: '#34D399', bodyPart: 'legs', category: 'movement', arduinoDuration: 4400 },
  { name: 'Sigilo atrás',         icon: '🐾', command: 'SNEAK_B',         color: '#34D399', bodyPart: 'legs', category: 'movement', arduinoDuration: 4400 },
  { name: 'Strut adelante',       icon: '🕺', command: 'STRUT_F',         color: '#F59E0B', bodyPart: 'legs', category: 'movement', arduinoDuration: 2500 },
  { name: 'Strut atrás',          icon: '🕺', command: 'STRUT_B',         color: '#F59E0B', bodyPart: 'legs', category: 'movement', arduinoDuration: 2500 },
  { name: 'Paso lateral izq',     icon: '⇦',  command: 'SIDE_STEP_L',     color: '#FBBF24', bodyPart: 'legs', category: 'movement', arduinoDuration: 2800 },
  { name: 'Paso lateral der',     icon: '⇨',  command: 'SIDE_STEP_R',     color: '#FBBF24', bodyPart: 'legs', category: 'movement', arduinoDuration: 2800 },
  { name: 'Paso lateral rápido',  icon: '⇆',  command: 'SIDE_STEP_FAST',  color: '#FBBF24', bodyPart: 'legs', category: 'movement', arduinoDuration: 10400 },
  { name: 'Inclinar izq',        icon: '⟧',  command: 'LEAN_L',          color: '#34D399', bodyPart: 'body', category: 'expression', arduinoDuration: 875 },
  { name: 'Inclinar der',        icon: '⟨',  command: 'LEAN_R',          color: '#34D399', bodyPart: 'body', category: 'expression', arduinoDuration: 875 },
  { name: 'Inclinar adelante',    icon: '⬆',  command: 'LEAN_F',          color: '#34D399', bodyPart: 'body', category: 'expression', arduinoDuration: 875 },
  { name: 'Inclinar atrás',       icon: '⬇',  command: 'LEAN_B',          color: '#34D399', bodyPart: 'body', category: 'expression', arduinoDuration: 875 },
  ...
  { name: 'Balanceo',            icon: '↔',  command: 'BALANCE',         color: '#38BDF8', bodyPart: 'body', category: 'dance',    arduinoDuration: 6000 },
  { name: 'Rock izq-der',        icon: '⤧',  command: 'ROCK_LR',         color: '#38BDF8', bodyPart: 'body', category: 'dance',    arduinoDuration: 900 },
  { name: 'Rock rápido',         icon: '⚡',  command: 'ROCK_LR_FAST',    color: '#38BDF8', bodyPart: 'body', category: 'dance',    arduinoDuration: 810 },
  { name: 'Rock adelante-atrás', icon: '⤵',  command: 'ROCK_FB',         color: '#38BDF8', bodyPart: 'body', category: 'dance',    arduinoDuration: 1800 },
  { name: 'Postura abierta',      icon: '🦵', command: 'WIDE_STAND',      color: '#F472B6', bodyPart: 'legs', category: 'movement', arduinoDuration: 750 },
  { name: 'Pájaro izq',          icon: '🐦', command: 'PIGEON_L',        color: '#F472B6', bodyPart: 'legs', category: 'movement', arduinoDuration: 750 },
  { name: 'Pájaro der',          icon: '🐦', command: 'PIGEON_R',        color: '#F472B6', bodyPart: 'legs', category: 'movement', arduinoDuration: 750 },
  { name: 'Patada izq',          icon: '🥾', command: 'KICK_L',          color: '#F87171', bodyPart: 'legs', category: 'dance',    arduinoDuration: 800 },
  { name: 'Patada der',          icon: '🥾', command: 'KICK_R',          color: '#F87171', bodyPart: 'legs', category: 'dance',    arduinoDuration: 800 },
  { name: 'Pisotón doble',        icon: '💥', command: 'STOMP',           color: '#F87171', bodyPart: 'legs', category: 'dance',    arduinoDuration: 810 },
  { name: 'Stomp izq',           icon: '⬇',  command: 'STOMP_L',         color: '#F87171', bodyPart: 'legs', category: 'dance',    arduinoDuration: 485 },
  { name: 'Stomp der',           icon: '⬇',  command: 'STOMP_R',         color: '#F87171', bodyPart: 'legs', category: 'dance',    arduinoDuration: 485 },
  { name: 'Stomp alternado',     icon: '⬇',  command: 'STOMP_ALTERNATE', color: '#F87171', bodyPart: 'legs', category: 'dance',    arduinoDuration: 3900 },
  { name: 'Hi-five izq',         icon: '✋',  command: 'HI_FIVE_L',       color: '#F59E0B', bodyPart: 'arms', category: 'expression', arduinoDuration: 460 },
  { name: 'Hi-five der',         icon: '✋',  command: 'HI_FIVE_R',       color: '#F59E0B', bodyPart: 'arms', category: 'expression', arduinoDuration: 460 },
  { name: 'Agacharse',           icon: '⤵',  command: 'CROUCH',          color: '#A3E635', bodyPart: 'legs', category: 'movement', arduinoDuration: 800 },
  { name: 'Squat',              icon: '🏋️', command: 'SQUAT',           color: '#A3E635', bodyPart: 'legs', category: 'movement', arduinoDuration: 1400 },
  { name: 'Squat pulse',        icon: '↯',  command: 'SQUAT_PULSE',     color: '#A3E635', bodyPart: 'legs', category: 'movement', arduinoDuration: 850 },
  ...
  { name: 'Shimmy',             icon: '💃', command: 'SHIMMY',          color: '#F472B6', bodyPart: 'body', category: 'dance',    arduinoDuration: 1600 },
  { name: 'Shimmy lento',       icon: '💃', command: 'SHIMMY_SLOW',     color: '#F472B6', bodyPart: 'body', category: 'dance',    arduinoDuration: 2200 },
  { name: 'Swing',              icon: '🌊', command: 'SWING',           color: '#FBBF24', bodyPart: 'body', category: 'dance',    arduinoDuration: 3400 },
  { name: 'Swing grande',       icon: '🌊', command: 'SWING_BIG',       color: '#FBBF24', bodyPart: 'body', category: 'dance',    arduinoDuration: 3400 },
  { name: 'UpDown',             icon: '⬆⬇',command: 'UPDOWN',          color: '#6366F1', bodyPart: 'body', category: 'dance',    arduinoDuration: 3400 },
  { name: 'UpDown grande',      icon: '⬆⬇',command: 'UPDOWN_BIG',      color: '#6366F1', bodyPart: 'body', category: 'dance',    arduinoDuration: 3400 },
  { name: 'Bounce',             icon: '↕',  command: 'BOUNCE',          color: '#6366F1', bodyPart: 'body', category: 'dance',    arduinoDuration: 2400 },
  { name: 'Bounce grande',      icon: '↕',  command: 'BOUNCE_BIG',      color: '#6366F1', bodyPart: 'body', category: 'dance',    arduinoDuration: 2000 },
  { name: 'Body roll',          icon: '🌀', command: 'BODY_ROLL',       color: '#F472B6', bodyPart: 'body', category: 'dance',    arduinoDuration: 3900 },
  { name: 'Body roll rápido',   icon: '🌀', command: 'BODY_ROLL_FAST',  color: '#F472B6', bodyPart: 'body', category: 'dance',    arduinoDuration: 2400 },
  { name: 'Wave izq',           icon: '〰', command: 'WAVE_L',          color: '#38BDF8', bodyPart: 'body', category: 'dance',    arduinoDuration: 3400 },
  { name: 'Wave der',           icon: '〰', command: 'WAVE_R',          color: '#38BDF8', bodyPart: 'body', category: 'dance',    arduinoDuration: 3400 },
  { name: 'Wave completa',      icon: '〰', command: 'WAVE_FULL',       color: '#38BDF8', bodyPart: 'body', category: 'dance',    arduinoDuration: 7600 },
  { name: 'Pulse LR',          icon: '⚡',  command: 'PULSE_LR',        color: '#38BDF8', bodyPart: 'body', category: 'dance',    arduinoDuration: 2800 },
  { name: 'Jitter',             icon: '⚡',  command: 'JITTER',          color: '#F472B6', bodyPart: 'body', category: 'dance',    arduinoDuration: 1840 },
  { name: 'Jitter pequeño',     icon: '⚡',  command: 'JITTER_SMALL',    color: '#F472B6', bodyPart: 'body', category: 'dance',    arduinoDuration: 1840 },
  { name: 'Disco izq',          icon: '🪩', command: 'DISCO_L',         color: '#F472B6', bodyPart: 'body', category: 'dance',    arduinoDuration: 2400 },
  { name: 'Disco der',          icon: '🪩', command: 'DISCO_R',         color: '#F472B6', bodyPart: 'body', category: 'dance',    arduinoDuration: 2400 },
  { name: 'Robot step',         icon: '🤖', command: 'ROBOT_STEP',      color: '#A78BFA', bodyPart: 'body', category: 'dance',    arduinoDuration: 2900 },
  { name: 'Robot rápido',       icon: '🤖', command: 'ROBOT_STEP_FAST', color: '#A78BFA', bodyPart: 'body', category: 'dance',    arduinoDuration: 2200 },
  { name: 'Ascendente',         icon: '⬆',  command: 'ASCENDING',       color: '#FBBF24', bodyPart: 'body', category: 'dance',    arduinoDuration: 4000 },
  { name: 'Punta',              icon: '👣', command: 'TIPTOE',          color: '#FBBF24', bodyPart: 'legs', category: 'dance',    arduinoDuration: 4400 },
  { name: 'Electric slide',     icon: '⚡',  command: 'ELECTRIC_SLIDE',  color: '#FBBF24', bodyPart: 'legs', category: 'dance',    arduinoDuration: 13600 },
  { name: 'Asustado',           icon: '😱', command: 'SCARED',          color: '#F87171', bodyPart: 'body', category: 'expression', arduinoDuration: 1000 },
  { name: 'Baile feliz',        icon: '😊', command: 'HAPPY_DANCE',     color: '#34D399', bodyPart: 'body', category: 'expression', arduinoDuration: 5200 },
  { name: 'Caminar triste',     icon: '😥', command: 'SAD_WALK',        color: '#60A5FA', bodyPart: 'body', category: 'expression', arduinoDuration: 11200 },
  { name: 'Mareado',            icon: '😵', command: 'DIZZY',           color: '#F472B6', bodyPart: 'body', category: 'expression', arduinoDuration: 10000 },
  { name: 'Cansado',            icon: '😴', command: 'TIRED',           color: '#F472B6', bodyPart: 'body', category: 'expression', arduinoDuration: 1350 },
  { name: 'Estornudo',          icon: '🤧', command: 'SNEEZE',          color: '#F472B6', bodyPart: 'body', category: 'expression', arduinoDuration: 450 },
  { name: 'Combo salsa',        icon: '💃', command: 'COMBO_SALSA',     color: '#F97316', bodyPart: 'body', category: 'combo',    arduinoDuration: 6600 },
  { name: 'Combo robot',        icon: '🤖', command: 'COMBO_ROBOT',     color: '#8B5CF6', bodyPart: 'body', category: 'combo',    arduinoDuration: 5400 },
  { name: 'Combo wave',         icon: '🌊', command: 'COMBO_WAVE',      color: '#38BDF8', bodyPart: 'body', category: 'combo',    arduinoDuration: 9700 },
  { name: 'Combo reggaetón',    icon: '🎶', command: 'COMBO_REGGAETON', color: '#F43F5E', bodyPart: 'body', category: 'combo',    arduinoDuration: 7200 },
  { name: 'Smooth',             icon: '🕴', command: 'SMOOTH',          color: '#A78BFA', bodyPart: 'body', category: 'combo',    arduinoDuration: 25000 },
  { name: 'Shake it',           icon: '🎉', command: 'SHAKE_IT',        color: '#F472B6', bodyPart: 'body', category: 'combo',    arduinoDuration: 10900 },
  { name: 'Demo',               icon: '🎬', command: 'DEMO',            color: '#60A5FA', bodyPart: 'body', category: 'combo',    arduinoDuration: 120000 },
...
const darkModeStore = createStore<boolean>(
...
export function useDarkMode() {
  const dark = useSyncExternalStore(darkModeStore.subscribe, darkModeStore.get);
  const toggle = useCallback(() => {
    darkModeStore.set(prev => {
      const next = !prev;
